...
- **Livello 1** – Agent Builder 
- **Livello 2** – Copilot Studio 

Il livello 1 è consigliato per chi non ha alcuna esperienze pregressa nella creazione di agenti Copilot; chi ha confidenza con Agent Builder può fare riferimento direttamente al livello 2.

Per confronto, supporto o feedback, contattateci mediante i canali indicati sul sito sopraccitato.
